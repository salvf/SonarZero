package sonarzero.api.sound.core.decoder;
...
public class WavConverter extends Decoder {
    public static void main(String[] args) throws Exception {
        File temp = File.createTempFile("sonartemp", ".wav");
        temp.deleteOnExit();
        System.out.println(temp.getAbsolutePath());
        WavConverter.convert("C:\\Users\\terro\\Desktop\\AudioVSTs\\wav\\mp3\\Waltz - Percussions Section.mp3", temp.getAbsolutePath());
    }
